...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript" src="/js/enjoyshop.js" charset="utf-8"></script>
</head>
<body id="mainframe">
<!--shortcut start-->
...
<!--shortcut end-->
	...
	<div class="s-content payment-info">
        ...
        <div class="way-list">
	        			        				         <div class="way-item">
			            乐购快递&nbsp;&nbsp;中小件商品&nbsp;&nbsp;<font color='#FF6600;'>工作日、双休日与假日均可送货</font> &nbsp;  
		...
		<div class="invoice-content">
				...
				<div class="ftx-04 invoice-prompt">
                    <dl class="clearfix">
                       <dt>温馨提示：</dt>
                       <dd>
                           <div>发票的开票金额不包括乐购卡/乐购E卡、优惠券和京豆支付部分</div>
		...
		<table class="order-table">
			...
			<c:forEach items="${carts }" var="cart">
				  <tr>
				    <td class="fore1">
					   <div class="p-goods">
						  <div class="p-img"><a href="http://www.enjoyshop.com/item/${cart.itemId}.html" target='_blank'><img width="52" height="52" src="${cart.itemImage}"></a></div>
							 <div class="p-detail">
								<div class="p-name">
...
<div class="bt bt-w freight-tooltip hide" id="transport">
   ...
   <div class="w">
	...
	$('#bill-tip-btn').Jtips({//随点随帮tip弹出
		"content":'<a target="_blank" href="http://help.jd.com/help/question-61.html#kjfpf">如何区分乐购销售和第三方卖家销售的商品?</a>',
		"close":true,			
	    "position": 'bottom'
	});
	//<![CDATA[
