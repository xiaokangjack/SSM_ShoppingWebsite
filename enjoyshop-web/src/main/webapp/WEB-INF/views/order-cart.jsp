...
<div class="w w1 header clearfix">
    <div id="logo"><a href="http://www.enjoyshop.com/"><img src="/images/enjoyshop-logo.gif" alt="乐购商城"></a></div>
</div>
<!-- /header -->
...
<div class="step-cont" id="skuPayAndShipment-cont">
   ...
   <!--满赠套装商品-->
     <!--配送方式-->
      <h4 class="vendor_name_h" id="0">商家：乐购商城</h4>
      <!--单品开始-->
	 ...
	 <c:forEach items="${carts }" var="cart">     						
        <div class="goods-item goods-item-extra">
				...
				<div class="p-img">
					<a target="_blank" href="http://www.enjoyshop.com/item/${cart.itemId}.html"><img src="${cart.itemImage}" alt=""></a>
				</div>
				<div class="goods-msg">					
					<div class="p-name">
					     <a href="http://www.enjoyshop.com/item/${cart.itemId}.html" target="_blank">
					           ${cart.itemTitle }				     
					     </a>
					</div>
          <div class="p-price">
         ...
         <!--配送方式-->
                  ...
                  <div class="mode-tab-nav">
                    <ul>
							...
							<span id="jdShip-span-tip" class="m-txt">乐购快递<i class='qmark-icon qmark-tip' data-tips='由乐购公司负责配送，速度很快，还接受上门刷卡付款服务'></i></span><b></b>
                        </li>
...
<script type="text/javascript">
        ...
        function doSavePickShipDate(venderId){
           ...
           jQuery.closeDialog();
			         ...
			         <!--以下为乐购第三方配送-->					
					 				<!--以下为第三方配送-->	 				
				<!--如果是SOP快递或者是乐购中小件商品，但是不支持配送，则采用快递运输-->
				   			</div><!--dis-modes 结束-->
			<div class="clr"></div>
	   ...
	   <!-- 乐购配送 -->
	   <input type="hidden" id="saveParam_jdShipmentType" name="saveParam.jdShipmentType" value="" /><!--乐购配送-->
	   ...
	   <input type="hidden" id="saveParam_jdCheckType" name="saveParam.jdCheckType" value="2"/><!--如果是支票这个只是写死的[仅支持乐购上门自取]-->
	   <input type="hidden" id="saveParam_jdBigItemShipTimeOffset" name="saveParam.jdBigItemShipTimeOffset" value="0"/><!--乐购大家电安装时间偏移量-->
	   <input type="hidden" id="saveParam_jdBigItemInstallTimeOffest" name="saveParam.jdBigItemInstallTimeOffest" value="0"/><!--乐购大家电配送时间偏移量-->	  
	   <!--311-->
	   ...
	   <input type="hidden" id="saveParam_jdBigItemNightShip" name="saveParam.jdBigItemNightShip" value="false"/><!--大家电是否支持晚间配送-->	   	   
	    <!--乐购第三方配送-->
	   <input type="hidden" id="saveParam_otherShipmentType" name="saveParam.otherShipmentType" value=""/><!--乐购第三方配送-->
	   <input type="hidden" id="saveParam_otherShipTime" name="saveParam.otherShipTime" value=""/><!--区分工作日，311，411-->	   
	   <input type="hidden" id="saveParam_otherBigItemShipOffset" name="saveParam.otherBigItemShipOffset" value=""/><!--乐购大家电安装时间偏移量-->
	   <input type="hidden" id="saveParam_otherBigItemInstallTimeOffset" name="saveParam.otherBigItemInstallTimeOffset" value=""/><!--乐购大家电配送时间偏移量-->
    ...
    <div class="list" id="showFreeFreight"  style="display:none;" >
      <span>运费优惠：</span><em class="price" id="freeFreightPriceId"> -￥0.00</em>
		...
		<div class="list" id="showGiftCardPrice"  style="display:none;" >
			<span>乐购卡/E卡：</span><em class="price" id='giftCardPriceId'>-￥ 0.00</em>
		</div>
    ...
    <div class="ui-ceilinglamp checkout-buttons">
      ...
      <div class="sticky-wrap">
          ...
          <div style="display:none" id="factoryShipCodShowDivBottom" class="dispatching">
            部分商品货到付款方式：先由乐购配送“提货单”并收款，然后厂商发货。
          </div>
        </div>
