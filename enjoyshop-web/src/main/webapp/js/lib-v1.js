...
var category = {OBJ: $("#_JD_ALLSORT"),
		URL_Serv: "http://manage.enjoyshop.com/rest/api/item/cat?callback=category.getDataService",
        ...
        return "" == c ? d : (/^http[s]?:\/\/([\w-]+\.)+[\w-]+([\w-.\/?%&=]*)?$/.test(c) || (c = c.replace(/-000$/, ""), c = c.match(/^\d*-\d*$/) ? "http://channel.jd.com/" + c + ".html" : "http://www.enjoyshop.com" + c + ".html"), '<a href="' + c + '">' + d + "</a>")
