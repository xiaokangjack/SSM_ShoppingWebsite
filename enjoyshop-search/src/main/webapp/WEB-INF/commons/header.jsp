<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<script type="text/javascript" src="http://static.enjoyshop.com/js/base-v1.js" charset="utf-8"></script>
<!--shortcut start-->
<jsp:include page="../commons/shortcut.jsp" />
<!--shortcut end-->
<div id="o-header-2013">
	<div class="w" id="header-2013">
		<div id="logo-2013" class="ld"><a href="http://www.enjoyshop.com/" hidefocus="true" clstag="homepage|keycount|home2013|02a"><b></b><img src="http://static.enjoyshop.com/images/enjoyshop-logo.gif" width="270" height="60" alt="乐购"></a></div>
		<!--logo end-->
		<div id="search-2013">
		...
		<div id="my360buy-2013">
			<dl>
				<dt class="ld"><s></s><a href="http://home.jd.com/" clstag="homepage|keycount|home2012|04a">我的乐购</a><b></b></dt>
				<dd>
		...
		<div id="settleup-2013" clstag="homepage|keycount|home2013|05a">
			<dl>
				<dt class="ld"><s></s><span class="shopping"><span id="shopping-amount"></span></span><a href="http://www.enjoyshop.com/cart.html" id="settleup-url">去购物车结算</a> <b></b> </dt>
<!-- 				<dd>
					<div class="prompt">
						<div class="loading-style1"><b></b>加载中，请稍候...</div>
					</div>
	...
	<div class="w">
		<div id="nav-2013">
			...
			<div id="treasure" clstag="homepage|keycount|home2013|08a"></div>
				<ul id="navitems-2013">
					<li class="fore1" id="nav-home" clstag="homepage|keycount|home2013|07a"><a href="http://www.enjoyshop.com/">首页</a></li>
