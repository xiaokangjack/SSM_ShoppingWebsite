...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
   ...
   <link rel="stylesheet" href="http://static.enjoyshop.com/css/base.css">
   <link href="http://static.enjoyshop.com/css/purchase.2012.css?v=201410141639" rel="stylesheet" type="text/css">
   <title>我的购物车 - 乐购商城</title>
   <script>
   	var pageConfig  = {};
   </script>
<body> 
...
<div class="w w1 header clearfix">
	<div id="logo"><a href="http://www.enjoyshop.com/"><img clstag="clickcart|keycount|xincart|logo" src="http://static.enjoyshop.com/images/enjoyshop-logo.gif" title="返回乐购商城首页" alt="返回乐购商城首页"></a></div>
	        ...
	        <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
		        <div class="item_form clearfix">
		            ...
		            <div class="cell p-goods">
		                ...
		                <div class="p-name">
		                	<a href="http://www.enjoyshop.com/item/${cart.itemId }.html" clstag="clickcart|keycount|xincart|productnamelink" target="_blank">${cart.itemTitle}</a>
        ...
        <div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;"><div class="cart-dibu ui-ceilinglamp-current" style="width: 988px; height: 49px;">
          <div class="control fdibu fdibucurrent">
              ...
              <span class="shopping">
                  ...
                  <a href="http://www.enjoyshop.com/" target="_blank" clstag="clickcart|keycount|xincart|coudanlink" id="continue">继续购物</a>
              </span>
          </div>
          <div class="cart-total-2014">
              <div class="cart-button">
                  <span class="check-comm-btns" id="checkout-jd">
                      <a class="checkout" href="http://www.enjoyshop.com/order/create.html" clstag="clickcart|keycount|xincart|gotoOrderInfo" id="toSettlement">去结算<b></b></a>
                  </span>
...
<script type="text/javascript" src="http://static.enjoyshop.com/js/base-v1.js"></script>
<!-- footer start -->
<jsp:include page="../commons/footer.jsp" />
<!-- footer end -->

<!-- 购物车相关业务 -->
<script type="text/javascript" src="http://static.enjoyshop.com/js/cart.js"></script>
<script type="text/javascript" src="http://static.enjoyshop.com/js/jquery.price_format.2.0.min.js"></script>
