...
<head>
    ...
    <title>注册-个人用户</title>
    <link type="text/css" rel="stylesheet" href="http://static.enjoyshop.com/css/regist.personal.css"/>
    <link type="text/css" rel="stylesheet" href="http://static.enjoyshop.com/css/passport.base.css"/>
    <script type="text/javascript" src="http://static.enjoyshop.com/js/jquery-1.2.6.min.js"></script>
</head>
<body>
...
<div class="w" id="logo">
    <div>
    	<a href="http://www.enjoyshop.com/">
    		<img src="http://static.enjoyshop.com/images/enjoyshop-logo.gif" alt="乐购商城" width="170" height="60"/>
    	</a> <b></b>
    </div>
</div>
...
<div class="w" id="regist">
    <div class="mt">
        ...
        <span style="text-align: right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="flk13"
                ...
                href="http://www.enjoyshop.com/user/login.html"
    ...
    <div class="mc">
        <form id="personRegForm" method="post" onsubmit="return false;">
            ...
            <div class="form" onselectstart="return false;">
                ...
                <div id="o-password">
                    ...
                    <div class="fl item-ifo">
                        ...
                        <label for="protocol">我已阅读并同意<a href="#" class="blue" id="protocol">《乐购用户注册协议》</a></label>
                        <span class="clr"></span>
            ...
            <div class="phone">
                <img width="180" height="180" src="http://static.enjoyshop.com/images/phone-bg.jpg">
            </div>
                        <span class="clr"></span>
        </form>
    </div>
...
<script type="text/javascript" src="http://static.enjoyshop.com/js/register/jd.lib.js"></script>
<script type="text/javascript" src="http://static.enjoyshop.com/js/register/jdThickBox.js"></script>
<script type="text/javascript" src="http://static.enjoyshop.com/js/register/jdValidate.js"></script>
<script type="text/javascript" src="http://static.enjoyshop.com/js/register/jdValidate.emReg.js"></script>
<script type="text/javascript" src="http://static.enjoyshop.com/js/register/jdValidate.regSuccess.js"></script>
