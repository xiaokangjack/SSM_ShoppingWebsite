...
<head>
    ...
    <title>登录乐购</title>
    <link type="text/css" rel="stylesheet" href="http://static.enjoyshop.com/css/login.css"/>
    <script type="text/javascript" src="http://static.enjoyshop.com/js/jquery-1.2.6.min.js"></script>
    <script type="text/javascript" src="http://static.enjoyshop.com/js/login/g.base.js"></script>
   	<script type="text/javascript" src="http://static.enjoyshop.com/js/login/jdEdit.js"></script>
...
<div class="w">
    <div id="logo">
    	<a href="http://www.enjoyshop.com/" clstag="passport|keycount|login|01">
    		<img src="http://static.enjoyshop.com/images/enjoyshop-logo.gif" alt="乐购" width="170" height="60"/>
    	</a><b></b>
   	</div>
</div>
...
<script type="text/javascript" src="http://static.enjoyshop.com/js/login/jdThickBox.js"></script>
<script type="text/javascript" src="http://static.enjoyshop.com/js/login/checkClient.js"></script>
<script>
