    ...
    <div class="easyui-layout" data-options="fit:true">
        ...
        <div data-options="region:'center'" style="padding:5px">
            <table class="easyui-datagrid" id="contentList" data-options="toolbar:contentListToolbar,singleSelect:false,collapsible:true,pagination:true,method:'get',pageSize:20,url:'/rest/content',queryParams:{categoryId:0}">
		                                                                                                                                                                                 <!-- queryParams:{categoryId:0}指定传入一个参数为categoryId，默认为0 -->
		    <thead>
		        <tr>
		            ...
		            <th data-options="field:'url',width:60,align:'center',formatter:ENJOYSHOP.formatUrl">内容连接</th>
		            <th data-options="field:'pic',width:50,align:'center',formatter:ENJOYSHOP.formatUrl">图片</th>
		            <th data-options="field:'pic2',width:50,align:'center',formatter:ENJOYSHOP.formatUrl">图片2</th>
